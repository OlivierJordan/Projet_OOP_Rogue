    ...
    public void initialize() {
        ...
        switch (main_character.hero_classe) {
            ...
            case 2:
                ...
                lbl_des_ult.setText("[Ulti] enchantemant magic : fait des dégats physique et magic mais fait pertre 12.5 PV");
    ...
    public void choose_monster(int floor){
        ...
        pause.setOnFinished(event -> {
            ...
            ///  si besoin ennemie faible
                ...
                if (choise_monster > 5) {
                    current_enemie = new monstre(0.35,0.25,0,0.2,0.2,"squelette",1,85,0,1);
                ...
                /// si le nombre ramdom est entre 5 et 1 : nouveau monstre = werewolf
                    ...
                    current_enemie = new monstre(0.4,0.4,0,0.4,0.2,"werewolf",2,120,0,1);
